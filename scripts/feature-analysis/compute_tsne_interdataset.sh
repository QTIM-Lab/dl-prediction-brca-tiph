...
echo 'Started t-SNE on Regression Model Training on TCGA-BRCA Database.'
...
do
    python code/feature_analysis/conch/compute_tsne_interdataset.py \
    --gpu_id 0 \
    --seed 42 \
...
echo 'Finished t-SNE on Regression Model Training on TCGA-BRCA Database.'