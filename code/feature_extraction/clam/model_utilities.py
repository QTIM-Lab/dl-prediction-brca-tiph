# Note: Classes modified from PyTorch official ResNet implementation
# PyTorch Imports
...
# Function: Build ResNet50 baseline
...
# Function: Load pre-trained weights
