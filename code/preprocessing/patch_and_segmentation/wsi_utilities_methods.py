...
# Project Imports
from wsi_utilities_classes import Mosaic_Canvas



# Function: isWhitePatch
...
# Function: Save patch as an iterable bag (HDF5)
...
# Function: Initialize the HDF5 bag
...
# Function: Get scores in the format of percentiles
...
# Function: Get the screen coordinates
...
# Function: Sample regions of interest (ROIs)
...
# Function: Draw grid on an image
...
# Function: Draw map from coordinates
...
# Function: Stich tiles in a patches-based system
...
# Method: Stitch tiles in a coordinate-based system
def StitchCoords(hdf5_file_path, wsi_object, downscale=16, draw_grid=False, bg_color=(0,0,0), alpha=-1, verbose=False):
